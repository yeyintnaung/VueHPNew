            ...
            <nav class="rd-navbar top-panel-none-items" data-layout="rd-navbar-fixed" data-hover-on="false"
                ...
                <div class="rd-navbar-top-panel">
                    <div class="rd-navbar-inner">
                        ...
                        <a href="/cdn-cgi/l/email-protection#a98a" class="fa-envelope">
                            <span class="__cf_email__"  data-cfemail="86e2e3ebe9ebe7efeac6e2e3ebe9eaefe8eda8e9f4e1">[email&#160;protected]</span></a><a
                ...
                <div class="rd-navbar-inner">
                    ...
                    <div class="rd-navbar-panel col-sm-2">
                        ...
                        <div class="rd-navbar-brand"> <a href="index.html" class="brand-name" >
                            <img
                                src="../../../assets/images/logo-2.png" class="logo_img" alt="" style="float:left;">
                            <h3 style="color:white;">HivePhing</h3>
                        </a>
                        </div>
                        <!--END RD Navbar Brand-->
                    </div>
            ...
            <div class="container">
                <div class="row flow-offset-1">
                    <div class="col-md-6 col-md-offset-3 btn-shadow inset-sm-min bg-white">
                        ...
                        <form class="row label-insets" v-on:submit.prevent="goregister">
                            <div class="form-group col-sm-6">
                                <label for="exampleInputText1" class="text-uppercase">{{$lang.messages.default.proposal_form.name}}</label>
                                <input type="text" v-bind:placeholder="$lang.messages.default.proposal_form.name" id="exampleInputText1" class="form-control"
                                       v-model="name">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" v-bind:placeholder="$lang.messages.default.auth.phone" id="exampleInputText2"
                            ...
                            <div class="form-group col-sm-12">
                                <label for="exampleInputEmail1" class="text-uppercase">{{$lang.messages.default.auth.password}}</label>
                                <input type="password" v-bind:placeholder="$lang.messages.default.auth.password" id="exampleInputEmail1"
                                ...
                                <template v-if="success === false">
                                    <template v-if="error.password !== undefined">
                                            ...
                                            <strong style="color: #ff292996; font-size: 15px;" v-for="epsw in error.password">
                                                {{epsw}}
                                            </strong>
                            ...
                            <div class="form-group col-sm-6">
                                <label for="exampleInputPass1" class="text-uppercase">{{$lang.messages.default.auth.confirm_psw}}</label>
                                <input type="password" v-bind:placeholder="$lang.messages.default.auth.confirm_psw" id="exampleInputPass1"
                            ...
                            <div class="col-sm-6">
                                <button type="submit" class="btn btn-primary btn-xs round-xl btn-block form-el-offset-1">Create account
                                </button>
                            </div>
                            <!--<div class="col-xs-12 text-center">-->
                                <!--<p class="small text-uppercase text-light-clr font-secondary max-width separate">or</p>-->
                                <!--<div class="btn-elements-group-2"><a href="#"-->
                                                                     <!--class="btn btn-info btn-xs round-small btn-icon-left btn-min-width"><span-->
    ...
    export default{
        ...
        methods: {
            ...
            goregister: function () {
                ...
                return axios({
                    method: 'post',
                    url: 'http://localhost/userHpbk/api/register',
                    data: {
                        phone: self.phone,
