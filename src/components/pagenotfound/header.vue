<template>
<div>
    <header class="bg-image bg-image-2 page-header">
            ...
            <nav class="rd-navbar top-panel-none-items" data-layout="rd-navbar-fixed" data-hover-on="false" data-stick-up="false" data-sm-layout="rd-navbar-fullwidth" data-md-layout="rd-navbar-static">
                <div class="rd-navbar-top-panel">
                    <div class="rd-navbar-inner">
                        <button data-rd-navbar-toggle=".list-inline, .fa-envelope, .fa-phone, .material-icons-shopping_cart" class="rd-navbar-collapse-toggle"><span></span></button><a href="/cdn-cgi/l/email-protection#7556" class="fa-envelope"><span class="__cf_email__" data-cfemail="f195949c9e9c90989db195949c9e9d989f9adf9e8396">[email&#160;protected]</span></a><a href="callto:#" class="fa-phone">+1 (126) 598-89-75</a>
                ...
                <div class="rd-navbar-inner">
                    ...
                    <div class="rd-navbar-panel">
                        ...
                        <!--RD Navbar Brand-->
                        <div class="rd-navbar-brand"><a href="index.html" class="brand-name"><img src="images/logo-2.png" alt=""></a>
                        </div>
                        <!--END RD Navbar Brand-->
                    </div>
                    <!--END RD Navbar Panel-->
        ...
        <section class="well-xl text-center user-info-section user-info-section--mod-1">
            <div class="container">
                <h1 class="text-uppercase text-white header-404">404.<small class="text-white text-bold">PAGE NOT FOUND</small></h1>
                <div class="col-md-6 col-md-offset-3 well">
                    <p class="text-white">The page requested couldn't be found - this could be due to a spelling error in the URL or a removed page.</p><a href="index.html" class="btn btn-default btn-sm round-xl offset-2">Back to homepage</a>
                </div>
            </div>
        </section>
        <!--End section-->
