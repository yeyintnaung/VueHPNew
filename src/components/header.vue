<template>
    <div >
        <div>{{$lang.messages.default.hello_world}}</div>
        <header class="page-header dark">
                ...
                <nav class="rd-navbar bg-white" data-layout="rd-navbar-fixed" data-hover-on="false" data-stick-up="false" data-sm-layout="rd-navbar-fullwidth" data-md-layout="rd-navbar-static">
                    <div class="rd-navbar-top-panel">
                        <div class="rd-navbar-inner">
                            <button data-rd-navbar-toggle=".list-inline, .fa-envelope, .fa-phone, .material-icons-shopping_cart" class="rd-navbar-collapse-toggle"><span></span></button><a href="/cdn-cgi/l/email-protection#0f2c" class="fa-envelope"><span class="__cf_email__" data-cfemail="dbbfbeb6b4b6bab2b79bbfbeb6b4b7b2b5b0f5b4a9bc">[email&#160;protected]</span></a><a href="callto:#" class="fa-phone">+1 (126) 598-89-75</a>
                    ...
                    <div class="rd-navbar-inner">
                        ...
                        <div class="rd-navbar-panel">
                            ...
                            <!--RD Navbar Brand-->
                            <div class="rd-navbar-brand"><a href="index.html" class="brand-name"></a>
                            </div>
                            <!--END RD Navbar Brand-->
                        </div>
                        <!--END RD Navbar Panel-->
            ...
            <section>
                ...
                <div class="rd-parallax">
                    <div data-speed="0.6" data-type="media" data-url="/static/images/header-1.jpg" class="rd-parallax-layer"></div>
                    <div data-speed="0.78" data-type="html" data-fade="true" class="well-parallax jumbotron text-center rd-parallax-layer">
                        <img class="logo_img"
                             src="../assets/images/logo.png"
                             alt="" style="width:155px;height:102px;"></a>
                        <h1 style="color:#ffae00;">HivePhing<small>The best real time search engine to browse skillful contractors in Myanmar.</small></h1>
                        <p class="big">Save time and no cost to get the best reliable contractors<br> Trust us ,we always provide you the best services<br>We are dedicated to your home endurance</p><div class='btn-group-variant'> <a class='btn btn-default round-xl btn-sm' href='login'>Login</a> <a class='btn btn-default round-xl btn-sm' href='register'>Register</a></div>
                    </div>
                </div>
            </section>
        </header>
