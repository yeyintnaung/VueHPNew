...
;(function ($) {
    if ($("html").hasClass("smoothscroll-all")) {
        include('rd-smoothscroll.min.js');
    }
})($);
;(function ($) {
    var o = $('html');
    if (o.hasClass('desktop')) {
        include('jquery.ui.totop.min.js');
        $(document).ready(function () {
...
;(function ($) {
    ...
    if (o.length > 0) {
        include('jquery.easy-responsive-tabs.min.js');
        $(document).ready(function () {
            o.each(function () {
                var $this = $(this);
                $this.easyResponsiveTabs({type: $this.attr("data-type") === "accordion" ? "accordion" : "default"});
            })
        });
    }
})($);
...
;(function ($) {
    ...
    if (o.length > 0) {
        ...
        $(document).ready(function () {
            var responsive = {};
            var aliaces = ["-xs-", "-sm-", "-md-", "-lg-"], values = [480, 768, 992, 1200], i, j, val;
            responsive[0] = {
            ...
            o.RDNavbar({responsive: responsive});
        });
    }
})($);
;(function ($, undefined) {
            ...
            $(document).on("scroll", $.proxy(function () {
                o.not('.animated').each(function () {
                    ...
                    if (($(window).scrollTop() + $(window).height()) > position) {
                        ...
                        $this.css({width: end + '%'});
                        $this.parent().find('span').counter({start: start, end: end, time: 0.4, step: 20});
                        $this.addClass('animated');
                    }
                });
            }, $(this))).trigger("scroll");
            ...
            o.each(function () {
                ...
                c.owlCarousel({
                    ...
                    onInitialized: function () {
                        if ($.fn.magnificPopup) {
                            var o = this.$element.attr('data-lightbox') !== "gallery", g = this.$element.attr('data-lightbox') === "gallery";
                            if (o) {
...
;(function ($) {
    var o = $('#svg-phone_1'), msie = !!navigator.userAgent.match(/Trident\/7\./);
    if ((o.length) && (!msie)) {
        $(document).ready(function () {
...
;(function ($) {
    var o = $('#DateCountdown');
    if (o.length) {
        include('TimeCircles.js');
        $(document).ready(function () {
            var time = {
                "Days": {"text": "Days", "color": "#febc66", "show": true},
                "Hours": {"text": "Hours", "color": "#febc66", "show": true},
                "Minutes": {"text": "Minutes", "color": "#febc66", "show": true},
                "Seconds": {"text": "Seconds", "color": "#febc66", "show": true}
            };
            o.TimeCircles({
                "animation": "smooth",
                "bg_width": 0.4,
            ...
            $(window).on('load resize orientationchange', function () {
                if ($(window).width() < 479) {
                    o.TimeCircles({time: {Minutes: {show: true}, Seconds: {show: false}}}).rebuild();
                } else if ($(window).width() < 767) {
                    o.TimeCircles({time: {Seconds: {show: false}}}).rebuild();
                } else {
...
;(function ($) {
    var o = $('[data-lightbox]').not('[data-lightbox="gallery"] [data-lightbox]'), g = $('[data-lightbox^="gallery"]');
    if (o.length > 0 || g.length > 0) {
        ...
        $(document).ready(function () {
            if (o.length) {
                o.each(function () {
                    var $this = $(this);
                    $this.magnificPopup({type: $this.attr("data-lightbox")});
                })
            }
            if (g.length) {
                g.each(function () {
...
;(function ($) {
    ...
    if (o.length) {
        ...
        $(document).ready(function () {
            o.each(function () {
                var _this = this, iso = new Isotope(_this, {
            ...
            $("[data-isotope-filter]").on("click", function () {
                ...
                $('.isotope[data-isotope-group="' + this.getAttribute("data-isotope-group") + '"]').isotope({filter: this.getAttribute("data-isotope-filter") == '*' ? '*' : '[data-filter="' + this.getAttribute("data-isotope-filter") + '"]'});
            })
        });
    }
})(jQuery);
...
;(function ($) {
    var o = $('.form-label');
    if (o.length) {
        include('mailform/jquery.rd-input-label.js');
        $(document).ready(function () {
            o.RDInputLabel();
        });
    }
